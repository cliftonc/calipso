...
var tabJs = '<script type="text/javascript">$(document).ready(function(){$(".form-fields").addClass("tab_container");$(".tab_container").removeClass("form-fields");$(".tab_container > .section").addClass("tab_content");$(".tab_container > div > section").hide();$(".tab_content").hide();$("ul.tabs li:first").addClass("active").show();$(".tab_content:first").show();$("ul.tabs li").click(function(){$("ul.tabs li").removeClass("active");$(this).addClass("active");$(".tab_content").hide();var activeTab=$(this).find("a").attr("href");$(activeTab).fadeIn();return false})});</script>';
