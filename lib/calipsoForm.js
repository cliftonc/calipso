...
//TODO - find a better way to flag this inside of templates/default/scripts.html
var tabJs = '<script type="text/javascript"src="http://code.jquery.com/jquery-1.6.1.min.js"></script><script type="text/javascript">$(document).ready(function(){$(".form-fields").addClass("tab_container");$(".tab_container").removeClass("form-fields");$(".tab_container > div").addClass("tab_content");$(".tab_container > div > section").hide();$(".tab_content").hide();$("ul.tabs li:first").addClass("active").show();$(".tab_content:first").show();$("ul.tabs li").click(function(){$("ul.tabs li").removeClass("active");$(this).addClass("active");$(".tab_content").hide();var activeTab=$(this).find("a").attr("href");$(activeTab).fadeIn();return false})});</script>';
...
CalipsoForm.prototype.formTabs = function(sections) {
  ...
  var tabOutput = '<ul class="tabs">';

  sections.forEach( function(section) {
    tabOutput += '<li><a href="#' + section.id + '">' + t(section.label) + '</a></li>';
  });
  return tabOutput + '</ul>';
...
CalipsoForm.prototype.end_form = function(form) {
  ...
  return '</div></div>' + (form.tabs ? tabJs : '</form>') ;
};
...
CalipsoForm.prototype.render_sections = function(sections, values) {
  ...
  sections.forEach( function(section) {
    sectionOutput += (
      ...
      '<section><h3>' + t(section.label) + '</h3></section>' +
...
>>>>>>> ed4b6ec59841ce4b7b6de8494e449b631c8dda41
        }
      }
