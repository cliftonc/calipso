      ...
      var theme = {                
        ...
        render: function(req, res, next) {
            ...
            processTheme(req,res,layout,theme,function() {
              ...
              var content = cache[layout].call({},res.bufferedOutput);              
              next(content);
...
function testFunction(req,res,layout,theme,next) {
  next("HELLO");
}
    ...
    if(layoutConfig.sections[section].blocks) {
      ...
      if(themeCacheFn) {
        ...
        themeCacheFn(req,themeOptions,function(fnOptions) {
            ...
            // res.bufferedOutput[section] += "HELLO";
            res.bufferedOutput[section] += themeCache.call({},themeOptions);
            next();
      ...
      res.bufferedOutput[section] += themeCache.call({},{});      
      next();
