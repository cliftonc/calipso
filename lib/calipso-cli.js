...
function createApplicationAt(path) {
  ...
  var items = [
    ...
    {dest:path + '/lib/calipso.js', source:calipsoPath + '/lib/calipso-proxy.js'},
    ...
    {dest:path + '/media'},
    {dest:path + '/tmp'},
    {dest:path + '/utils/googleTranslate.js', source:calipsoPath + '/utils/googleTranslate.js'},
    {dest:path + '/app-cluster.js', source:calipsoPath + '/app-cluster-proxy.js'},
    {dest:path + '/app.js', source:calipsoPath + '/app-proxy.js'}
  ];
