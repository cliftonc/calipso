...
function CalipsoEventEmitter(options) { 
  ...
  if(typeof this.options.maxListeners !== "number"){
  	var maxListeners = parseInt(this.options.maxListeners);
  }else{
  	var maxListeners = this.options.maxListeners;
  }
  
  this.emitter.setMaxListeners(maxListeners || 100);
...
function ModuleInitEventEmitter(moduleName, options) {
  ...
  // Verify the type of self.options.maxListeners
  if(typeof self.options.maxListeners !== "number"){
  	var maxListeners = parseInt(self.options.maxListeners);
  }else{
  	var maxListeners = self.options.maxListeners;
  }
