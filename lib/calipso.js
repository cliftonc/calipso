...
//console.log('WrapRoot', wrapRoot);
//console.log('WrapCalipso', wrapCalipso);
      ...
      if (mod[0] == '.') {
        ...
        if (full.substr(0, wrapRoot.length) == wrapRoot) {
          ...
          try {
            ...
            //console.log('found relative to site', local);
            return res;
          }
          catch (e) {
            res = module.require(full);
            //console.log('found in root', full);
            return res;
          }
        }
      }
