 ...
 *
 */
function initialiseCalipso(next) {
    ...
    if (!calipso.theme) {
      ...
      calipso.app.stack.forEach(function(middleware,key) {
       ...
       if(middleware.handle.tag === 'theme.stylus') {
         var mw = calipso.app.mwHelpers.stylusMiddleware(calipso.app.path,themeName);
         calipso.app.stack[key].handle = mw;
       }

       if(middleware.handle.tag === 'theme.static') {
         var mw = calipso.app.mwHelpers.staticMiddleware(calipso.app.path,themeName);
         calipso.app.stack[key].handle = mw;
       }
