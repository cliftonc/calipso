...
exports.boot = function(next) {
      ...
      require(path + '/conf/configuration.js')(
              app,
              express,
              function(err) {
                if (err) {
                  console
                      .log("There was a fatal error attempting to load the " +
                      		"configuration, application will terminate.");
                }
...
/**
 * App settings and middleware Any of these can be added into the by environment
 * configuration files to enable modification by env.
 */
function bootApplication(app) {
  ...
  var stylusMiddleware = stylus.middleware({
          src: __dirname + '/themes/' + theme + '/stylus',
          dest: __dirname + '/themes/' + theme + '/public',
          debug: false,
