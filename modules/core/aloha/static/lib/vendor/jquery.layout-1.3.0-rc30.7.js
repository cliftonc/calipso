...
// alias Math methods - used a lot!
    ...
    $.layout = {
      ...
      version:"1.3.rc30.7", revision:0.033007 // 1.3.0 final = 1.0300 - major(n+).minor(nn)+patch(nn+)
      ...
      , browser:{
        ...
        , msie:!!$.browser.msie, isIE6:$.browser.msie && $.browser.version == 6, boxModel:$.support.boxModel !== false || !$.browser.msie // ONLY IE reverts to old box-model - update for older jQ onReady
...
// Set stateManagement as a layout-option, NOT a pane-option
    ...
    $.layout.state = {
       ...
       */, loadState:function (inst, stateData, opts) {
        ...
        if (!$.isPlainObject(stateData) || $.isEmptyObject(stateData)) {
          return;
        }
