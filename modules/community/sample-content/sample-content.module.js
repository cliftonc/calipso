 ...
 */
exports = module.exports = {init: init, route: route, install: install, reload: reload, disable: disable};
...
function renderSampleContentPage(req, res, template, block, next) {
  ...
  calipso.form.process(req, function(incomingForm) {
    ...
    var sampleForm = {
      id:'sample-content-form',cls:'sample-content-form',title:'Sample Content Form',type:'form',method:'POST',action:'/sample-content',
      fields:[
        {label:'Text', name:'sample-text', type:'text'},
        {label:'Textarea', name:'sample-textarea', type:'textarea'},
        {label:'Password', name:'sample-password', type:'password'},
        // "simple" select (values are used for displayed text also):
        {label:'Select (simple)', name:'sample-select-simple', type:'select', options:[
          'Option 1',
          'Option 2',
          'Option 3'
        ]},
        // typical select (values may differ from displayed text):
        {label:'Select (typical)', name:'sample-select-typical', type:'select', options:[
          {label: 'alpha', value: '1'},
          {label: 'beta', value: '2'},
          {label: 'gamma', value: '3'}
        ]},
        // optgroup select (has optgroups with both simple and typical option sets):
        {label:'Select (optgroups)', name:'sample-select-optgroups', type:'select', optgroups:[
          {label: 'Option Group 1', options:[
            'Option 1',
            'Option 2',
            'Option 3'
          ]},
          {label: 'Option Group 2', options:[
            {label: 'delta', value: '4'},
            {label: 'epsilon', value: '5'},
            {label: 'zeta', value: '6'}
          ]},
          {label: 'Option Group 3', options:[
            'Option 7',
            'Option 8',
            'Option 9'
          ]}
        ]},
        {label:'Radio 1', name:'radios', type:'radio', value:'1'},
        {label:'Radio 2', name:'radios', type:'radio', value:'2'},
        {label:'Radio 3', name:'radios', type:'radio', value:'3'},
        {label:'Checkbox 1', name:'checkbox1', type:'checkbox', value:'1'},
        {label:'Checkbox 2', name:'checkbox2', type:'checkbox', value:'2'},
        {label:'Checkbox 3', name:'checkbox3', type:'checkbox', value:'3'},
        {label:'File', name:'file', type:'file'},
      ],
      buttons:[
        {name:'cancel', type:'button', link:'/', value:'Cancel'},
